...
> {
  ...
  if (!accounts.editionMintAuthority.value) {
    if (accounts.holderDelegateRecord.value) {
      if (accounts.delegate.value) {
        accounts.editionMintAuthority.value =
          getNonNullResolvedInstructionInput(
            'delegate',
        ...
        accounts.editionMintAuthority.value =
          getNonNullResolvedInstructionInput('payer', accounts.payer.value);
      }
    } else {
  ...
  return Object.freeze({
    accounts: [
      ...
      getAccountMeta('holderDelegateRecord', accounts.holderDelegateRecord),
